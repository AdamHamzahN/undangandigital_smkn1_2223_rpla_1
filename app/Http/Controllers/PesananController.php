...
class PesananController extends Controller
{
    ...
    {
        $id_pemesan_terakhir = Pemesan::latest('id_pemesan')->first()->id_pemesan;
        ...
        $undangan->id_pengantin = $pengantin->id_pengantin;
        ...
        $pesanan->id_pemesan = $id_pemesan_terakhir;
        $pesanan->id_undangan = $undangan->id;
        $pesanan->save();
        // Periksa apakah penyimpanan berhasil
        if ($pengantin->save() && $akad->save() && $resepsi->save() && $pesanan->save()) {
